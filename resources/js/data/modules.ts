...
/**
 * Pilar Reparto desactivado a pedido del cliente (2026-09). El objeto
 * `repartoModule` de abajo queda intacto — solo se excluye del array
 * `modules` exportado. Para reactivarlo: poner esto en `true` Y
 * `reparto_habilitado` en `true` en config/modules.php (o
 * MODULE_REPARTO_ENABLED=true en .env).
 */
export const REPARTO_HABILITADO = false;

const repartoModule: ModuleDef = {
    title: 'Reparto',
    slug: 'reparto',
    icon: Truck,
    accent: '#D4102A',
...
export const modules: ModuleDef[] = [
    ...
    ...(REPARTO_HABILITADO ? [repartoModule] : []),
    {
        title: 'Gente',
        slug: 'gente',
        icon: Users,
