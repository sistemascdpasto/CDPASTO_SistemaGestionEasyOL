...
import { CalendarDays, LoaderCircle, Upload } from 'lucide-react';
...
export function ImportarAusentismoDialog({ trigger }: { trigger: React.ReactNode }) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post('/modules/gente/ausentismo/importar', {
            forceFormData: true,
            onSuccess: () => {
                reset();
                setOpen(false);
                ...
                <DialogHeader>
                    ...
                    <DialogDescription className="text-xs text-slate-500">
                        ...
                        <span className="font-semibold text-slate-700 dark:text-slate-300">
                            Apellidos, Nombres, Identificador, Grupo, Fecha, Permiso, Turno, Entró, Atraso, Salió, Adelanto (Bloque 1 y Bloque 2)
                        </span>
                    </DialogDescription>
                </DialogHeader>
