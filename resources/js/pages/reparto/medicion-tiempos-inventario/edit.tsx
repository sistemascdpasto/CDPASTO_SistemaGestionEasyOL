...
export default function MedicionTiemposInventarioEdit({ registro, vehiculos, colaboradores }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Editar Medición #${registro.id}`} />

            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <HeadingSmall>Editar Medición #{registro.id}</HeadingSmall>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-4 pt-4 border-t">
                            ...
                            <Button type="submit" disabled={processing}>
                                ...
                                {processing ? 'Actualizando...' : 'Actualizar Medición'}
                            </Button>
                        </div>
                    </form>
                </div>
