...
class RevisarVencimientoDocumentosFlota extends Command
{
    ...
    protected $description = 'Notifica por correo a Flota/Administrador los vehículos con SOAT (15 días antes) o tecnomecánica (30 días antes) próximos a vencer.';
    ...
    public function handle(): int
    {
        ...
        if ($destinatarios->isEmpty()) {
            $this->warn('No hay usuarios con rol Flota o Administrador con correo registrado.');
